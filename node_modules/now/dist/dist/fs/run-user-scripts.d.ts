...
export declare function spawnAsync(command: string, args: string[], opts?: SpawnOptions): Promise<void>;
export declare function execAsync(command: string, args: string[], opts?: SpawnOptions): Promise<{
    stdout: string;
    stderr: string;
    code: number;
}>;
...
export declare function getNodeVersion(destPath: string, minNodeVersion?: string, config?: Config): Promise<NodeVersion>;
